...
chapter5_items = [
    ...
    ItemData(ItemIDs.bromider, ItemClassification.filler),
    ItemData(ItemIDs.bromidef, ItemClassification.filler),
    ...
    ItemData(ItemIDs.monarchrbn, ItemClassification.useful, groups=[ItemGroups.armors]),
    ItemData(ItemIDs.truetie, ItemClassification.useful, groups=[ItemGroups.armors]),
    ItemData(ItemIDs.dogwidow, ItemClassification.useful, groups=[ItemGroups.armors]),
