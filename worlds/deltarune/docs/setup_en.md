...
If your game isn't installed on your `C:` drive, or if it's not working for some reason, input the directory as explained in the previous instruction, like `/auto_patch "[directory]"`. Don't forget quotation marks!
