...
from InclusionLogic import (
    is_chapter_randomized,
    is_normal_route,
    is_weird_route,
    should_include_hidden_items,
    should_include_hidden_items_chapter2_weird_route_exclusion,
    should_include_secret_bosses_items_requirement_chapter2_weird_route_exclusion,
    should_include_secret_bosses_items_reward,
    should_include_secret_bosses_items_reward_chapter2_weird_route_exclusion,
)
...
chapter2_items = [
    ...
    ItemData(
        ItemIDs.dogdollar,
        ItemClassification.filler,
        should_be_included=should_include_hidden_items_chapter2_weird_route_exclusion,
    ...
    ItemData(
        ItemIDs.emptydisk,
        ItemClassification.progression,
        should_be_included=should_include_secret_bosses_items_requirement_chapter2_weird_route_exclusion,
    ...
    ItemData(
        ItemIDs.dealmaker,
        ItemClassification.useful,
        should_be_included=should_include_secret_bosses_items_reward_chapter2_weird_route_exclusion,
        groups=[ItemGroups.armors],
    ),
    ItemData(
        ItemIDs.puppetscarf,
